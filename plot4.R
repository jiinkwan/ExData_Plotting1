...
library(lubridate)
library(dplyr)
fileName <- c("household_power_consumption.zip","household_power_consumption.txt")
...
with(householdPowerConsumption, plot(V10, Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
...
with(householdPowerConsumption, plot(V10, Global_reactive_power, type = "l", ylab = "Global Reactive Power", xlab = ""))
